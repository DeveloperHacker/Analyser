...
def tree_output(attention_states,
    ...
    with vs.variable_scope("TreeOutputs"):
...
def strings_output(cell, inputs_states, tokens_states, string_length, num_words, hidden_size):
    with vs.variable_scope("StringsOuputs"):
        ...
        strings_logits = tf.reshape(strings_logits,
                                    [num_conditions, sequence_length, string_length, batch_size, num_words])
