...
#     def __init__(self, output, logits, scope):
#         self.output = output
#         self.scope = scope
#         self.logits = logits
#
#     def flatten(self):
#         return self.output, self.scope, self.logits
#
#
# class QFunctionOutputs(AnalyserOutputs):
#     def __init__(self, output, scope, q):
#         super().__init__(output, None, scope)
#         self.q = q
#
#     def flatten(self):
...
class QFunctionNet(Net):
    def __init__(self):
        super().__init__(Q_FUNCTION_MODEL)
        self.inputs = None
        self.inputs_sizes = None
        self.output = None
